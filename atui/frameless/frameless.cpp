...
/***** WidgetData *****/
WidgetData::WidgetData(FramelessPrivate *_d, QWidget *pTopLevelWidget)
{
    d = _d;
...
void Frameless::activateOn(QWidget *topLevelWidget)
{
...
void Frameless::removeFrom(QWidget *topLevelWidget)
{
...
void Frameless::setWidgetMovable(bool movable)
{
    d->m_bWidgetMovable = movable;
}

void Frameless::setWidgetResizable(bool resizable)
{
...
void Frameless::setBorderWidth(int width)
{
    if (width > 0)
    {
...
void Frameless::setTitleHeight(int height)
{
    if (height > 0)
    {
...
bool Frameless::widgetMovable()
{
    return d->m_bWidgetMovable;
}

bool Frameless::widgetResizable()
{
    return d->m_bWidgetResizable;
}

bool Frameless::rubberBandOnMove()
{
    return d->m_bRubberBandOnMove;
}

bool Frameless::rubberBandOnResisze()
{
    return d->m_bRubberBandOnResize;
}

uint Frameless::borderWidth()
{
    return CursorPosCalculator::m_nBorderWidth;
}

uint Frameless::titleHeight()
{
