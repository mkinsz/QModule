...
void WidgetData::handleWidgetEvent(QEvent *e)
{
    switch (e->type())
    {
    default: break;
    case QEvent::Leave: handleLeaveEvent(static_cast<QMouseEvent*>(e)); break;
    case QEvent::MouseMove: handleMouseMoveEvent(static_cast<QMouseEvent*>(e)); break;
    case QEvent::HoverMove: handleHoverMoveEvent(static_cast<QHoverEvent*>(e)); break;
    case QEvent::MouseButtonPress: handleMousePressEvent(static_cast<QMouseEvent*>(e)); break;
    case QEvent::MouseButtonRelease: handleMouseReleaseEvent(static_cast<QMouseEvent*>(e)); break;
    }
}
...
void WidgetData::handleMousePressEvent(QMouseEvent *e)
{
    if (e->button() == Qt::LeftButton)
    {
        m_bLeftButtonPressed = true;
        m_bLeftButtonTitlePressed = e->pos().y() < m_moveMousePos.m_nTitleHeight;

        QRect frameRect = m_pWidget->frameGeometry();
        m_pressedMousePos.recalculate(e->globalPos(), frameRect);
        m_ptDragPos = e->globalPos() - frameRect.topLeft();
    }
}

void WidgetData::handleMouseReleaseEvent(QMouseEvent *e)
{
    if (e->button() == Qt::LeftButton)
    {
        m_bLeftButtonPressed = false;
...
void WidgetData::handleMouseMoveEvent(QMouseEvent *e)
{
...
void WidgetData::handleLeaveEvent(QEvent *e)
{
    Q_UNUSED(e)
    if (!m_bLeftButtonPressed)
    {
...
void WidgetData::handleHoverMoveEvent(QHoverEvent *e)
{
    if (d->m_bWidgetResizable)
    {
        updateCursorShape(m_pWidget->mapToGlobal(e->pos()));
    }
}
