...
void MainWindow::keyPressEvent(QKeyEvent *event)
{
    if(event->key() == Qt::Key_Left) {
        ...
        switch (i) {
        case 1: m_pCenter->setAlignment(CCenterWindow::TopLeft);     break;
        case 2: m_pCenter->setAlignment(CCenterWindow::TopCenter);   break;
        case 3: m_pCenter->setAlignment(CCenterWindow::TopRight);    break;
        case 4: m_pCenter->setAlignment(CCenterWindow::RightTop);    break;
        case 5: m_pCenter->setAlignment(CCenterWindow::RightCenter); break;
        case 6: m_pCenter->setAlignment(CCenterWindow::RightBottom); break;
        case 7: m_pCenter->setAlignment(CCenterWindow::BottomRight); break;
        case 8: m_pCenter->setAlignment(CCenterWindow::BottomCenter);break;
        case 9: m_pCenter->setAlignment(CCenterWindow::BottomLeft);  break;
        case 10: m_pCenter->setAlignment(CCenterWindow::LeftBottom); break;
        case 11: m_pCenter->setAlignment(CCenterWindow::LeftCenter); break;
        case 12: m_pCenter->setAlignment(CCenterWindow::LeftTop);    break;
        default:;
        }
    }
