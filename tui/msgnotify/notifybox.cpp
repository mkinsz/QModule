...
NotifyBox::NotifyBox(int displayTime, QWidget *parent) : QWidget(parent),
...
void NotifyBox::mousePressEvent(QMouseEvent *event)
{
...
void NotifyBox::setUrl(const QString &value)
{
    url = value;
}

void NotifyBox::setBody(const QString &value)
{
    body = value;
}

void NotifyBox::setTitle(const QString &value)
{
    title = value;
}

void NotifyBox::setIcon(const QString &value)
{
    icon = value;
}
