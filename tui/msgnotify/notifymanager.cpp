...
void NotifyManager::rearrange()
{
    ...
    QRect desktopRect = pScreen->availableGeometry();
    QPoint bottomRignt = desktopRect.bottomRight();

    QList<NotifyBox *>::iterator i;
...
void NotifyManager::showNext()
{
    ...
    NotifyBox *notify = new NotifyBox(displayTime);
    ...
    connect(notify, &NotifyBox::disappeared, this, [notify, this]() {
