...
void ProgressBar::setBarBackGroundColor(QColor color)
{
...
void ProgressBar::setBarSplitLineColor(QColor color)
{
...
void ProgressBar::setBarColor(QColor color)
{
    if (color != m_barColor)
    {
        m_barColor = color;
...
void ProgressBar::setDecimal(int decimal)
{
...
void ProgressBar::setBarSplitLineDelta(int delta)
{
...
void ProgressBar::setShowBarSplitLine(bool show)
{
...
void ProgressBar::setSpace(int space)
{
    if (space != m_space)
    {
        m_space = space;
...
void ProgressBar::drawBackGround(QPainter &p, const QRectF &barRect, const QRectF &textRect)
{
    p.save();
    //进度条背景
    p.setPen(Qt::NoPen);
...
void ProgressBar::drawData(QPainter &p, const QRectF &barRect)
{
    p.save();
    p.setPen(Qt::NoPen);
...
void ProgressBar::drarBarSplitLine(QPainter &p, const QRectF &barRect)
{
    if (!m_showBarSplitLine)
        return;
    p.save();
...
void ProgressBar::drawText(QPainter &p, const QRectF &textRect)
{
    p.save();
    //画值
